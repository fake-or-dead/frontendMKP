              ...
              <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                <thead>
                  <tr>
                    ...
                    <th>{{ trans('admin/text_message.username') }}</th>
                    <th>{{ trans('admin/text_message.fNameLname') }}</th>
                    <th>{{ trans('admin/text_message.groupUser') }}</th>
                    <th>{{ trans('admin/text_message.createDate') }}</th>
                ...
                <tbody>
                  @foreach( $data as $key => $val )
                    <tr class="">
                      ...
                      <td>{{ $val->status }}</td>
                      <td class="center">
                        <a href="{{ action('Admin\UserController@edit',['id'=>$val->id]) }}" class="btn btn-default">{{ trans('admin/text_message.edit') }}</a>
                        <button onclick="deleteFn('{{ action('Admin\UserController@destroy',['id'=>$val->id]) }}')" class="btn btn-default">{{ trans('admin/text_message.delete') }}</button>
                      </td>
                    </tr>
                  @endforeach
                </tbody>
